...
const WeatherApp = () => {
  let api_key = "2e4b74a25995c6ce27a44f9761d9eb8d";
  ...
  return (
    <div className='container'>
      <div className="top-bar">
        <input type="text" className="cityinput" placeholder='Search Any City eg: London' />
      ...
      <div className="data-container">
        ...
        <div className="element">
          ...
          <div className="data">
            <div className="humidity-percent">Wind Speed</div>
